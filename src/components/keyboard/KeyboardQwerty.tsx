...
const enterKeyRowStyles = Object.assign(keyboardRowStyles, {
  display: "grid",
...
export const KeyboardQWERTY = ({
  ...
  return (
    <>
      <div
        className="mb-1 flex justify-center grid grid-cols-10"
      ...
      <div
        className="flex justify-center grid enter-key-row"
        style={enterKeyRowStyles}
      >
