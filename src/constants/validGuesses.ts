...
export const alphabet: Alphabet = {
  ...
  t: [
    ...
    "trains",
    "traits",
    "tramal", // MW only oddly
    "tramas", // MW only oddly
    "tramps",
    "trance",
    "tranks",
    "trapan",
    ...
    "trebly",
    "treens",
    "trefle", // MW only oddly - french
    "tremie", // MW only oddly - french
    "tremor",
    "trench",
    "trends",
    "trendy",
  ...
  x: ["xebecs", "xenial", "xenias", "xenons", "xoanon", "xylans"],
  y: [
    "yaasss",
    "yabber",
    "yachts",
...
export const possibilities = (
  ...
  possible
    .filter(
      (word: string) =>
        exclude(word.split(""), absent.split("")) &&
        include(word.split(""), mustInclude)
    )
    .filter(
      (word: string) =>
    ...
    .filter((word: string) =>
      word.split("").every((letter, i) => [" ", letter].includes(given[i]))
    );
