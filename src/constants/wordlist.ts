...
// function getMatches(matches: any, occurrences: any) {
//   let words = alphabet.o
//   Object.keys(matches).forEach(
//     (matchIndex: number) =>
//       (words = words.filter((word) => word[matchIndex] === matches[matchIndex]))
//   )
//   Object.keys(occurrences).forEach(
//     (letter) =>
//       (words = words.filter(
//         (word) => countOccurrences(word, letter) >= occurrences[letter]
//       ))
//   )
//   return words
// }
...
export const WORDS6 = alphabet.u
